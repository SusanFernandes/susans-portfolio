...
export default async function ProjectPage({
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <main className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-16 pt-24 pb-12">
        <div className="space-y-8 animate-fade-in-up">
          <div className="space-y-4 text-center max-w-3xl mx-auto">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-tight text-white mb-4">
              {project.title.split(" — ")[0]}
              <br />
              <span className="text-muted-foreground text-xl sm:text-2xl mt-2 block">
            ...
            <div className="flex flex-wrap justify-center gap-2 pt-4">
              {project.tech.map((tech) => (
                <span
                  key={tech}
                  className="px-3 py-1.5 text-xs border border-border rounded-full bg-muted/20 text-foreground hover:border-muted-foreground/50 transition-colors duration-300"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="pt-8 max-w-5xl mx-auto">
            <div className="mb-8 text-center">
              <h2 className="text-xl font-light inline-block relative after:content-[''] after:absolute after:-bottom-3 after:left-1/2 after:-translate-x-1/2 after:w-12 after:h-px after:bg-cyan-500/50">
                Detailed Breakdown
              </h2>
            </div>
